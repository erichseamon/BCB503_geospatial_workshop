...
We saw in [an earlier episode]({{ site.baseurl }}/03-raster-reproject-in-r/) that when working with raster data in different CRSs, we needed to convert all objects to the same

...
keypoints:
- Vector data structures represent specific features on the Earth's surface along
  with attributes of those features.
- Vector objects are either points, lines, or polygons.
objectives:
- Describe the strengths and weaknesses of storing data in vector format.
- Describe the three types of vectors and identify types of data that would be stored
  in each.
output: pdf_document
questions: What are the main attributes of vector data?
source: Rmd
teaching: 10
exercises: 5
---
